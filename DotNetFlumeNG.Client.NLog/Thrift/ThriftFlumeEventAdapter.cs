...
namespace DotNetFlumeNG.Client.Thrift
{
    ...
    {   
        public ThriftFlumeEventAdapter(LogEvent logEvent)
        {
            ...
            Headers["flume.client.log4j.logger.hive.table"] = logEvent.LoggerName;
            Headers["flume.client.log4j.logger.date"] = logEvent.Body.Substring(0, 10).Replace("-",string.Empty);
